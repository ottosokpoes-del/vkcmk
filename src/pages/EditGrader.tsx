...
const EditGrader = () => {
  ...
  const { graders, updateGrader } = useAppStore();
  ...
  // Grader bulunamadığında admin paneline yönlendir
  useEffect(() => {
    if (!grader && id) {
      navigate('/admin');
    }
  ...
  useEffect(() => {
    if (grader) {
      setFormData({
        title: grader.title || '',
        price: grader.price ? grader.price.toString() : '',
        year: grader.year ? grader.year.toString() : '',
        operatingHours: grader.operatingHours ? grader.operatingHours.toString() : '',
        fuel: grader.fuel || 'Dizel',
        transmission: grader.transmission || 'Manuel',
        location: grader.location || '',
        sellerType: grader.sellerType || 'Sahibinden',
        description: grader.description || '',
        images: grader.images && grader.images.length > 0 ? grader.images : [''],
        technicalSpecs: grader.technicalSpecs || {
          engine: '',
          power: '',
          torque: '',
          bladeWidth: '',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Grader Bulunamadı</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Grader Düzenle</h1>
                <p className="text-gray-600">{grader.title}</p>
              </div>
            </div>
