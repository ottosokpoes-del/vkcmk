    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <Link to="/" className="flex items-center space-x-2 flex-shrink-0">
              <div className="w-8 h-8 bg-gradient-to-br from-orange-600 to-orange-700 rounded-lg flex items-center justify-center shadow-md">
                <span className="text-white font-bold text-sm">G</span>
              </div>
              <span className="text-lg font-bold text-gray-900 hidden sm:block">GraderMarket</span>
            </Link>
            ...
            <div className="hidden lg:flex items-center space-x-4 mx-4">
              <Link 
                to="/" 
                className="relative text-gray-700 hover:text-orange-600 transition-colors font-medium px-3 py-2 rounded-md hover:bg-gray-50 group"
              >
                <span>Ana Sayfa</span>
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="hidden lg:flex items-center space-x-1">
                ...
                <button
                  onClick={openSearch}
                  className="flex items-center space-x-1 bg-gray-50 hover:bg-gray-100 text-gray-600 hover:text-orange-600 px-3 py-2 rounded-lg transition-all duration-200 border border-gray-200 hover:border-orange-600/30 hover:shadow-sm min-w-[120px]"
                >
                ...
                {user && (
                  <div className="relative group">
                    <button className="flex items-center space-x-1 p-1 text-gray-600 hover:text-orange-600 hover:bg-gray-50 rounded-lg transition-all duration-200">
                      <div className="w-7 h-7 bg-gradient-to-br from-orange-600 to-orange-700 rounded-full flex items-center justify-center">
                    ...
                    {/* Dropdown */}
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                      <div className="py-2">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-40 lg:hidden">
          <div className="absolute top-14 sm:top-16 left-0 right-0 bg-white shadow-xl border-t border-gray-200 max-h-[calc(100vh-3.5rem)] sm:max-h-[calc(100vh-4rem)] overflow-y-auto">
            <div className="px-4 py-4 sm:py-6 space-y-4">
              ...
              <div className="space-y-1">
                <Link 
                  ...
                  className="flex items-center px-3 py-2 text-gray-700 hover:text-orange-600 hover:bg-gray-50 rounded-md transition-colors font-medium text-sm"
                >
                  Ana Sayfa
                </Link>
                <Link 
              ...
              <div className="border-t border-gray-200 pt-4">
                  <div className="space-y-2">
                    {/* User Info */}
                    <div className="px-3 py-2 bg-gradient-to-r from-orange-50 to-orange-100 rounded-md">
                      <div className="flex items-center space-x-2">
                    ...
                    {/* Logout Button */}
                      ...
                      className="w-full flex items-center space-x-2 px-3 py-2 text-gray-700 hover:text-red-600 hover:bg-red-50 rounded-md transition-colors"
                      >
